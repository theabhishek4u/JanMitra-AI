...
const presets: PresetComplaint[] = [
  {
    ...
    lang: "Hindi / देवनागरी",
    category: "Sanitation & Waste (स्वच्छता एवं कचरा प्रबंधन)",
    priority: "HIGH",
    dept: "Lucknow Nagar Nigam (Zone 4) - नगर निगम लखनऊ",
  ...
  },
  {
    ...
    lang: "Hinglish / रोमन हिंदी",
    category: "Water Supply & Sewage (जल प्रदाय एवं जल निगम)",
    priority: "CRITICAL",
    dept: "Lucknow Jal Nigam (Zone 1) - जल निगम लखनऊ",
  ...
  },
  {
    ...
    category: "Public Safety & Electricity (विद्युत एवं प्रकाश व्यवस्था)",
    priority: "MEDIUM",
    dept: "Madhyanchal Vidyut Vitran Nigam (MVVNL) - विद्युत विभाग",
